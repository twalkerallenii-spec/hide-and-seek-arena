...
export async function build(ctx) {
  ...
  const MAT = {
    ...
    hullBig: M.surface('metalPanel', { color: 0xc9d2d8, panels: 2, repeat: 6, size: 256, roughness: 0.48, metalness: 0.3 }),
    ...
    grate: M.surface('metalPanel', { color: 0x59636b, panels: 12, repeat: 10, size: 256, roughness: 0.6, metalness: 0.62, normalScale: 1.4 }),
    grateDS: M.surface('metalPanel', { color: 0x59636b, panels: 12, repeat: 10, size: 256, roughness: 0.6, metalness: 0.62, normalScale: 1.4, side: THREE.DoubleSide }),
    ceil: M.surface('metalPanel', { color: 0xc2cad0, panels: 5, repeat: 7, size: 256, roughness: 0.52, metalness: 0.2 }),
    struct: M.surface('metalPanel', { color: 0x6b757e, panels: 2, repeat: 2, size: 256, roughness: 0.46, metalness: 0.72 }),
    stone: M.surface('marble', { color: 0xe6eaee, vein: 0x87a3b2, repeat: 12, size: 256, rough: 0.16 }),
    burnt: M.surface('rustMetal', { color: 0x2c3237, rust: 0x4d2f1a, repeat: 3, size: 256, roughness: 0.86, metalness: 0.45 }),
    engDeck: M.surface('metalPanel', { color: 0x4b5259, panels: 6, repeat: 7, size: 256, roughness: 0.66, metalness: 0.58 }),
    hydroFloor: M.surface('tile', { color: 0xe9eff1, grout: 0x64757c, tiles: 6, repeat: 7, size: 256, rough: 0.24 }),
    bayFloor: M.surface('concrete', { color: 0x878e95, repeat: 12, size: 256, roughness: 0.86 }),
